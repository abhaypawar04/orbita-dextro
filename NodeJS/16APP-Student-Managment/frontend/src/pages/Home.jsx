...
const Home = () => {
  ...
  return (
    <div
      className="page-wrapper relative min-h-screen bg-cover bg-center bg-fixed bg-no-repeat"
    ...
    >
      ...
      <div className="relative">
        <div className="container mx-auto px-4 py-12 md:py-16">
          ...
          <div className="grid items-center gap-12 md:grid-cols-2 lg:gap-16">
            <div>
              ...
              <p className="mt-6 max-w-xl text-lg leading-relaxed text-gray-600">
                A simple and efficient platform to manage student records,
                organize academic information, and keep everything in one place.
              </p>
                  ...
                  <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-gray-100">
                    ...
                    >
                      <path
                        ...
                        strokeWidth={2}
                        d="M9 19V6l3-2 3 2v13M5 19V9l3-2m8 12V9l3-2v12M3 19h18"
                      />
                    </svg>
                  </div>
                </div>
          ...
          <div className="mt-16 md:mt-20">
            <div className="mb-10 text-center">
              ...
              <p className="mt-2 text-gray-500">
                Simple tools to keep your student records organized.
              </p>
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-3">
              ...
              <div className="glass-card">
                ...
                <p className="mt-2 leading-relaxed text-gray-500">
                  Easily add and manage student profiles with detailed
                  information.
                </p>
              </div>
              ...
              <div className="glass-card">
                ...
                <p className="mt-2 leading-relaxed text-gray-500">
                  Quickly find students by name, course, department, or student
                  ID.
                </p>
              </div>
              ...
              <div className="glass-card">
                ...
                <p className="mt-2 leading-relaxed text-gray-500">
                  Monitor student information and keep academic records
                  organized.
                </p>
              </div>
            </div>
          ...
          {/* Bottom CTA */}
          <div className="mt-16 rounded-2xl bg-gray-900/95 p-8 text-center shadow-xl backdrop-blur-sm md:p-10">
